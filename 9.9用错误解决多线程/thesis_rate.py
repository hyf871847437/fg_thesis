...
class Ui_Dialog3(object):
    ...
    def rate_thesis(self):
        ...
        def look_up(my_file_path):
            ...
            #print reduce(add_rate, my_rate),type(reduce(add_rate, my_rate))
            return my_str + u'重复率：' + '%.2f' % (float(reduce(add_rate, my_rate)) / len(my_rate)) + '%'
