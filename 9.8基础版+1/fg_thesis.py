# -*- coding: utf-8 -*-
from PyQt4.QtGui import QMainWindow,QMessageBox,QInputDialog,QLineEdit,QDialog,QSplashScreen,QPixmap,QProgressDialog
from PyQt4 import QtGui,QtCore
from PyQt4.QtCore import pyqtSignature,QStringList,Qt,pyqtSignal,QThread,QTextCodec,QEvent
...
from look_up_thesis import Ui_Form_Look_Up
from create2 import Ui_Dialog4
from lxml import html
from decrease2 import Ui_Dialog
from thesis_rate import Ui_Dialog3
import webbrowser,time,docx,requests,threading,re
...
class Dialog(QDialog,Ui_Dialog2):             #查重显示界面
    def __init__(self,reslut,parent=None):

        QDialog.__init__(self,parent)
        self.setupUi(self)
        self.textBrowser.setText(reslut)
